...
from src.fr.hymaia.exo4.no_udf import (
    add_category_name_without_udf, calculate_total_price_per_category_per_day,
...
class TestNoUdf(unittest.TestCase):
    def test_add_category_name_without_udf(self):
        ...
        actual = add_category_name_without_udf(df)
        actual_list = [
            (
                row["id"],
                row["date"],
    ...
    def test_calculate_total_price_per_category_per_day(self):
        ...
        df_expected = spark.createDataFrame(
            [
                ...
                (0, "2019-02-16", 6, 40.0, "furniture", 143.0),
            ],
            [
                "id",
                "date",
    ...
    def test_add_category_name_without_udf_fail(self):
        df = spark.createDataFrame(
            [
                (0, "2019-02-16", 6, 40.0),
                (0, "2019-02-16", 6, 33.0),
